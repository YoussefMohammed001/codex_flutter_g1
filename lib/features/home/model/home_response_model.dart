...
// {
// "id": 12,
// "image": "https://student.valuxapps.com/storage/uploads/banners/1732574054JUQcm.6.jpg",
// "category": {
// "id": 42,
...
// }
// ],
// "ad": "https://student.valuxapps.com/storage/uploads/banners/1732402018qoY0L.banner1.png"
// }
// }
...
class HomeResponseModel {
  ...
  factory HomeResponseModel.fromJson({required Map<String, dynamic> json}) {
    return HomeResponseModel(
        status: json['status'],
        message: json['message'] ?? "",
        homeData: HomeData.fromJson(json: json['data']));
  }
}
...
class HomeData {
  ...
  HomeData({required this.homeBanners, required this.homeProducts});

  factory HomeData.fromJson({required Map<String, dynamic> json}) {
    return HomeData(
        homeBanners: (json['banners'] as List<dynamic>)
            .map((e) => HomeBanners.fromJson(json: e as Map<String, dynamic>))
            .toList(),
        homeProducts: (json['products'] as List<dynamic>)
            .map((e) => HomeProducts.fromJson(json: e as Map<String, dynamic>))
            .toList());
  }
}
...
class HomeBanners {
  final int id;
  final String image;
  HomeBanners({required this.id, required this.image});

  factory HomeBanners.fromJson({required Map<String, dynamic> json}) {
    return HomeBanners(id: json['id'], image: json['image']);
  }
}
...
class HomeProducts {
  ...
  factory HomeProducts.fromJson({required Map<String, dynamic> json}) {
    return HomeProducts(
        id: json['id'],
        price: json['price']  ,
